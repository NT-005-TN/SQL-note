...
2. [Основы SQL](#основы-sql)  
   2.1. [Диалекты SQL](#диалекты-sql)  
   2.2. [Общее для всех диалектов](#общее-для-всех)  
   &emsp;&nbsp;2.2.1. [Операторы SELECT](#операторы-select)  
   &emsp;&nbsp;2.2.2. [Логические операторы](#логические-операторы)  
   &emsp;&nbsp;2.2.3. [Агрегатные функции](#агрегатные-функции)  
   &emsp;&nbsp;2.2.4. [Группировка](#группировка)  
   &emsp;&nbsp;2.2.5. [Объединения](#объединения)  
   &emsp;&nbsp;2.2.6. [Подзапросы](#подзапросы)  
   &emsp;&nbsp;2.2.7. [Операции с множествами](#операции-с-множествами)  
   &emsp;&nbsp;2.2.8. [Отличия и особенности диалектов](#отличия-и-особенности-диалектов)  
3. [SQLite](#sqlite)  
   3.1. [Разбор кода](#разбор-кода)  
   3.2. [Операции с множествами](#операции-с-множествами-1)  
4. [PostgreSQL](#postgresql)  
   4.1. [Отличия от SQLite](#отличия-от-sqlite)  
5. [OracleSQL](#oraclesql)  
   5.1. [Отличия от других диалектов](#отличия-от-других-диалектов)  
