...
2. [Основы SQL](#основы-sql) \n\n
   ...
     2.2.1. [Операторы SELECT](#операторы-select) \n\n
     2.2.2. [Логические операторы](#логические-операторы) \n\n
     2.2.3. [Агрегатные функции](#агрегатные-функции) \n\n
     2.2.4. [Группировка](#группировка) \n\n
     2.2.5. [Объединения](#объединения) \n\n
     2.2.6. [Подзапросы](#подзапросы) \n\n
     2.2.7. [Операции с множествами](#операции-с-множествами) \n\n
     2.2.8. [Отличия и особенности диалектов](#отличия-и-особенности-диалектов) \n\n
3. [SQLite](#sqlite) \n\n
